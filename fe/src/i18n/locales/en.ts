...
export const en = {
  ...
  landing: {
    ...
    subtitle:
      'Registration, login, email verification, password change and recovery. A complete system built with NestJS, React and security best practices.',
    ...
    steps: {
      ...
      step3: {
        ...
        description:
          'With your active session, manage your profile and password from the dashboard.',
      },
    },
  ...
  auth: {
    ...
    register: {
      ...
      validation: {
        ...
        passwordWeak: 'Minimum 8 characters, one uppercase, one lowercase and one number.',
    ...
    changePassword: {
      ...
      validation: {
        ...
        newPasswordWeak: 'Minimum 8 characters, one uppercase, one lowercase and one number.',
