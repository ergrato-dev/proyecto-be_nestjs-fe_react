...
export const es = {
  ...
  landing: {
    ...
    subtitle:
      'Registro, login, verificación de email, cambio y recuperación de contraseña. Un sistema completo construido con NestJS, React y las mejores prácticas de seguridad.',
  ...
  auth: {
    ...
    register: {
      ...
      validation: {
        ...
        passwordWeak: 'Mínimo 8 caracteres, una mayúscula, una minúscula y un número.',
    ...
    verifyEmail: {
      ...
      successMessage: 'Tu correo ha sido verificado correctamente. Ya puedes iniciar sesión.',
    ...
    resetPassword: {
      ...
      successMessage: 'Contraseña restablecida correctamente. Redirigiendo al inicio de sesión...',
    ...
    changePassword: {
      ...
      validation: {
        ...
        newPasswordWeak: 'Mínimo 8 caracteres, una mayúscula, una minúscula y un número.',
...
// ¿Por qué sin `as const`? Con `as const` cada valor se tipa como su literal
// exacto (ej: 'Cargando...'), lo que rompe `en.ts satisfies TranslationKeys`
// apenas la traducción a otro idioma use un texto distinto. Sin `as const`
// TypeScript solo exige las mismas claves con valores `string` — sigue
// detectando claves faltantes o de más, sin forzar el mismo texto literal.
