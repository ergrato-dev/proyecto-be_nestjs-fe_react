    ...
    <div className="min-h-[calc(100vh-8rem)] px-4 py-12 max-w-3xl mx-auto">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            Al acceder y utilizar NN Auth System, aceptas quedar vinculado por estos Términos de
            Uso. Si no estás de acuerdo con alguna parte de estos términos, no debes usar el
            servicio.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            NN Auth System es un sistema de gestión de credenciales de acceso. Te comprometes a:
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>Proporcionar información veraz y actualizada al registrarte.</li>
            <li>Mantener la confidencialidad de tus credenciales de acceso.</li>
            <li>No compartir tu cuenta con terceros ni usarla para actividades no autorizadas.</li>
        ...
        <section className="space-y-3">
          ...
          <p>
            Eres responsable de todas las actividades realizadas bajo tu cuenta. NN se reserva el
        ...
        <section className="space-y-3">
          ...
          <p>
            Todo el contenido, código fuente y diseño del sistema son propiedad de NN. Queda
        ...
        <section className="space-y-3">
          ...
          <p>
            NN no será responsable de daños indirectos, incidentales o consecuentes derivados del
            uso o la imposibilidad de usar el servicio, siempre que no sean atribuibles a
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            ser publicados en esta página. El uso continuo del servicio implica la aceptación de los
            nuevos términos.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-medium text-gray-900 dark:text-slate-100">7. Contacto</h2>
          <p>
