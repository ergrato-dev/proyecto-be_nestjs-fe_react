        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <Mail size={18} className="mt-0.5 text-brand-600 dark:text-brand-400 shrink-0" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">
                  {t('contact.emailInfoLabel')}
                </p>
                <p className="text-sm text-gray-500 dark:text-slate-400">contacto@nn-company.com</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <Phone size={18} className="mt-0.5 text-brand-600 dark:text-brand-400 shrink-0" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">
                  {t('contact.phoneLabel')}
                </p>
                <p className="text-sm text-gray-500 dark:text-slate-400">+57 (1) 234-5678</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <MapPin size={18} className="mt-0.5 text-brand-600 dark:text-brand-400 shrink-0" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">
                  {t('contact.addressLabel')}
                </p>
                <p className="text-sm text-gray-500 dark:text-slate-400">Bogotá, Colombia</p>
              </div>
            </div>
          </div>
