  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400">{t('dashboard.sessionActive')}</p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-6 mb-6 max-w-md">
        ...
        <dl className="space-y-3">
          ...
          <div>
            ...
            <dd className="text-sm text-gray-900 dark:text-slate-100 font-medium">{user?.email}</dd>
          </div>
          <div>
            <dt className="text-xs text-gray-500 dark:text-slate-400">
