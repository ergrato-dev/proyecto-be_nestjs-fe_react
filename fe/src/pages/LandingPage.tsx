    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          >
            {t('landing.title')} <span className="text-brand-600 dark:text-brand-500">NestJS</span>
          </h1>
      ...
      >
        <header className="mb-12 text-center">
          ...
          <p className="mt-3 text-gray-500 dark:text-slate-400">{t('landing.featuresSubtitle')}</p>
        </header>
      ...
      >
        <header className="mb-14 text-center">
          <h2 id="how-heading" className="text-3xl font-bold text-gray-900 dark:text-slate-100">
            {t('landing.stepsHeading')}
          </h2>
          <p className="mt-3 text-gray-500 dark:text-slate-400">{t('landing.stepsSubtitle')}</p>
        </header>
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-10 text-gray-500 dark:text-slate-400">{t('landing.stackSubtitle')}</p>
