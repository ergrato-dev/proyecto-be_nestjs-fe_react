...
// eslint-disable-next-line react-refresh/only-export-components -- context+provider co-locados a propósito; useAuth.ts necesita importar AuthContext directamente.
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  useEffect(() => {
    ...
    // ¿Qué? Sin token no hay sesión que restaurar — resuelto de inmediato.
    // ¿Para qué? Mantener un único punto (`.finally`) que apaga el loading,
