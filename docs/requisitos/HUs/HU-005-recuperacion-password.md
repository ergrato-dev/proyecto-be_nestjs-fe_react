...
- El token de reset se genera con el módulo `crypto` de Node (`randomBytes(32)`) en `AuthService` — 256 bits de entropía, persistido en la entidad `PasswordResetToken`.
